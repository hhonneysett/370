    ...
    public class BookingController : Controller
    {
        ...
        public ActionResult captureDetails()
        {
            ...
            if (User.IsInRole("Admin"))
                site = Url.Action("employeeViewBookings", "Booking");
            else site = Url.Action("ViewBookings", "Booking");
        ...
        public void updateStatus(string status)
        {
            ...
            global.addAudit("Bookings", "Bookings: Updated Booking Status", "Update", User.Identity.Name);
